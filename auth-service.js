...
function initialize() {
    return new Promise((resolve, reject) => {
        ...
        let db = mongoose.createConnection("mongodb+srv://malnikast:Lnforte00@senecaweb.aklwkdq.mongodb.net/?retryWrites=true&w=majority", {useNewUrlParser: true, useUnifiedTopology: true});
        // Checking for errors
        db.on('error', (err)=>{
            reject(err);
        });
